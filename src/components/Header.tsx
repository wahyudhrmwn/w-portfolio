...
export default function Header() {
  ...
  const [isBookCallDrawerOpen, setIsBookCallDrawerOpen] = useState(false);
  ...
  return (
    <>
        ...
        <div className="bg-white/90 backdrop-blur-md border border-gray-200 rounded-full shadow-lg">
          <nav className="flex items-center justify-between px-6 py-3">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button
                className="bg-gray-900 hover:cursor-pointer text-white px-4 py-2 rounded-full hover:bg-gray-800 transition-colors book-call-btn"
        ...
        >
          <div className="mt-2 bg-white/95 backdrop-blur-md border border-gray-200 rounded-2xl shadow-lg overflow-hidden">
            <nav className="py-2">
              ...
              <a
                href="#"
                className="block px-6 py-3 text-gray-400 cursor-not-allowed pointer-events-none"
                aria-disabled="true"
              >
                Work
              </a>
              ...
              <div className="px-6 py-3">
                <button
                  className="w-full bg-gray-900 text-white px-4 py-2 rounded-full hover:bg-gray-800 transition-colors text-sm font-medium book-call-btn"
                  onClick={() => {
                    setIsMobileMenuOpen(false);
      ...
      <BookCallDrawer
        isOpen={isBookCallDrawerOpen}
        onClose={() => setIsBookCallDrawerOpen(false)}
      />
    </>
  );
}
